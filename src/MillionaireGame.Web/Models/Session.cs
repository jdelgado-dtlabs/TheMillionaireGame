...
public class Session
{
    ...
    public DateTime? QuestionStartTime { get; set; } // Timestamp when current question started (intro/display)
    public DateTime? VotingStartTime { get; set; } // Timestamp when voting actually began (for ATA)
