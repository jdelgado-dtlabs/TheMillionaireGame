...
public class GuestScreenForm : ScalableScreenBase, IGameScreen
{
            ...
            try
            {
                ...
                if (settingsManager != null)
                {
                    ...
                    if (activeTheme != null)
                    {
                        ...
                        GameConsole.Info($"[GuestScreenForm] Theme '{_activeTheme.Theme.ThemeName}' loaded for strap rendering");
    ...
    // IGameScreen interface stubs - FFF display not used on Guest screen (only TVScreenForm)
