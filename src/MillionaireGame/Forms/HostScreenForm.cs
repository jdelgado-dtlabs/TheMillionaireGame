...
public class HostScreenForm : ScalableScreenBase, IGameScreen
{
            ...
            try
            {
                ...
                if (settingsManager != null)
                {
                    ...
                    if (activeTheme != null)
                    {
                        ...
                        GameConsole.Info($"[HostScreenForm] Theme '{_activeTheme?.Theme?.ThemeName ?? "Unknown"}' loaded for strap and money tree rendering");
    ...
    public void RefreshTheme()
    {
        ...
        GameConsole.Info("[HostScreenForm] Refreshing theme for host screen");
            ...
            try
            {
                ...
                if (settingsManager != null)
                {
                    ...
                    if (activeTheme != null)
                    {
                        ...
                        _svgStrapRenderer ??= new SvgStrapRenderer();
                        _svgMoneyTreeRenderer ??= new SvgMoneyTreeRenderer();
                        GameConsole.Info($"[HostScreenForm] Theme '{_activeTheme?.Theme?.ThemeName ?? "Unknown"}' reloaded for host");
                    }
                }
            }
            catch (Exception ex)
            {
                GameConsole.Warn($"[HostScreenForm] Error refreshing theme: {ex.Message}");
            }
