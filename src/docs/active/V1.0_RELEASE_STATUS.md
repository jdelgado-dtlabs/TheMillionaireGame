...
**Post-v1.0 Fixes**: ✅ **COMPLETE**
- FFF rankings display fixed
- FFF player pre-selection removed
- Host Intro broadcast to lobby fixed
- ATA online detection fixed (LIVE session refactor)
- Session cleanup on shutdown added
